...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2018 at 06:08 AM
...
CREATE TABLE `hoa` (
  `idbong` int(11) NOT NULL,
  `mahoa` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tenhoa` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gia` float NOT NULL,
  `khuyenmai` float NOT NULL,
  `id_mau` char(10) COLLATE utf8mb4_unicode_ci NOT NULL
...
('khar', 158, '2018-04-30 03:18:17', 'khathts@yahoo.com.vn', 'kharomts95@gmail.com.vn');
...
--
ALTER TABLE `messager`
  MODIFY `id_messeger` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
